...
# Test function to create a complex network
def create_and_test_complex_network():
    # Create routers
    r1 = Router("R1")
    r2 = Router("R2")
    r3 = Router("R3")
    ...
    r1.add_interface("eth0", "192.168.1.1", "AA:BB:CC:DD:EE:01", "255.255.255.0")
    r1.add_interface("eth1", "10.0.0.1", "AA:BB:CC:DD:EE:02", "255.255.255.0")
    
    r2.add_interface("eth0", "10.0.0.2", "AA:BB:CC:DD:EE:03", "255.255.255.0")
    r2.add_interface("eth1", "172.16.0.1", "AA:BB:CC:DD:EE:04", "255.255.255.0")
    
    r3.add_interface("eth0", "172.16.0.2", "AA:BB:CC:DD:EE:05", "255.255.255.0")
    r3.add_interface("eth1", "192.168.2.1", "AA:BB:CC:DD:EE:06", "255.255.255.0")
    
    # Add routes to routers
    r1.add_route("172.16.0.0", "255.255.255.0", "10.0.0.2", "eth1")
    r1.add_route("192.168.2.0", "255.255.255.0", "10.0.0.2", "eth1")
    
    r2.add_route("192.168.1.0", "255.255.255.0", "10.0.0.1", "eth0")
    r2.add_route("192.168.2.0", "255.255.255.0", "172.16.0.2", "eth1")
    
    r3.add_route("192.168.1.0", "255.255.255.0", "172.16.0.1", "eth0")
    r3.add_route("10.0.0.0", "255.255.255.0", "172.16.0.1", "eth0")
    ...
    # Create end devices for first subnet
    pc1 = EndDevice("PC1", "00:11:22:33:44:01", "192.168.1.10", default_gateway="192.168.1.1")
    pc2 = EndDevice("PC2", "00:11:22:33:44:02", "192.168.1.11", default_gateway="192.168.1.1")
    pc3 = EndDevice("PC3", "00:11:22:33:44:03", "192.168.1.12", default_gateway="192.168.1.1")
    pc4 = EndDevice("PC4", "00:11:22:33:44:04", "192.168.1.13", default_gateway="192.168.1.1")
    pc5 = EndDevice("PC5", "00:11:22:33:44:05", "192.168.1.14", default_gateway="192.168.1.1")
    
    # Create end devices for second subnet
    pc6 = EndDevice("PC6", "00:11:22:33:44:06", "192.168.2.10", default_gateway="192.168.2.1")
    pc7 = EndDevice("PC7", "00:11:22:33:44:07", "192.168.2.11", default_gateway="192.168.2.1")
    pc8 = EndDevice("PC8", "00:11:22:33:44:08", "192.168.2.12", default_gateway="192.168.2.1")
    pc9 = EndDevice("PC9", "00:11:22:33:44:09", "192.168.2.13", default_gateway="192.168.2.1")
    pc10 = EndDevice("PC10", "00:11:22:33:44:10", "192.168.2.14", default_gateway="192.168.2.1")
    ...
    # Test communication between subnets
    print("Testing communication from PC1 to PC6...")
    result = pc1.send("Hello from PC1 to PC6", pc6)
    print(f"Communication successful: {result}")
    
    if result:
        print("PC6 received data:")
        for data in pc6.received_data:
            print(f"Layer {data['layer']} data: {data.get('data') or data.get('packet')}")
    
    return {
        'routers': [r1, r2, r3],
        'switches': [s1, s2],
        'devices': [pc1, pc2, pc3, pc4, pc5, pc6, pc7, pc8, pc9, pc10]
    }

# Test function for hub and bridge scenario
def create_and_test_hub_bridge_network():
    # Create Router
    r1 = Router("R1")
    r1.add_interface("eth0", "192.168.1.1", "AA:BB:CC:DD:EE:01", "255.255.255.0")
    r1.add_interface("eth1", "192.168.2.1", "AA:BB:CC:DD:EE:02", "255.255.255.0")
    ...
    # Create end devices for second subnet
    pc4 = EndDevice("PC4", "00:11:22:33:44:04", "192.168.2.10", default_gateway="192.168.2.1")
    pc5 = EndDevice("PC5", "00:11:22:33:44:05", "192.168.2.11", default_gateway="192.168.2.1")
    pc6 = EndDevice("PC6", "00:11:22:33:44:06", "192.168.2.12", default_gateway="192.168.2.1")
    ...
    # Test communication
    print("Testing communication from PC1 to PC4 (across subnets, through hub and bridge)...")
    result = pc1.send("Hello from PC1 to PC4", pc4)
    print(f"Communication successful: {result}")
    
    if result:
        print("PC4 received data:")
        for data in pc4.received_data:
            print(f"Layer {data['layer']} data: {data.get('data') or data.get('packet')}")
    ...
    return {
        ...
        'bridge': b1,
        'switches': [s1, s2],
        'devices': [pc1, pc2, pc3, pc4, pc5, pc6]
    }
